<?php
// packages/Webkul/ChannelManager/src/Repositories/ChannelRepository.php

namespace Webkul\ChannelManager\Repositories;

use Illuminate\Container\Container;
use Illuminate\Support\Facades\Event; // Thêm nếu muốn dùng Events
use Illuminate\Support\Facades\Log;
use Webkul\Core\Eloquent\Repository;
use Webkul\ChannelManager\Contracts\Channel; // Sử dụng Contract
...
class ChannelRepository extends Repository
{
    ...
    {
        return \Webkul\ChannelManager\Models\Channel::class; // Trỏ đến Model Channel
    }
